\hypertarget{md_signal_opt_service_readme_autotoc_md79}{}\doxysubsection{Introduction}\label{md_signal_opt_service_readme_autotoc_md79}
...
\end{longtabu}
\hypertarget{md_signal_opt_service_readme_autotoc_md82}{}\doxysubsection{Additional parameters}\label{md_signal_opt_service_readme_autotoc_md82}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_signal_opt_service_readme_autotoc_md83}{}\doxysection{Implementation}\label{md_signal_opt_service_readme_autotoc_md83}
